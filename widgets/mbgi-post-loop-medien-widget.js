const BlockEditPostLoopmedienWidget = (props) => { 	//wie der block beim bearbeiten des posts angezeigt werden soll
	...
	return createElement("div", null, // Container-Element
		[createElement(InspectorControls, {key: "mbgi-post-loop-inspectorcontrols"},
			...
			key: "mbgi-medien-widget-inspectorcontrols-panelbody",
			title: "Einstellungen",
			initialOpen: true
			},
			[
				createElement(SelectControl, {
					key: "mbgi-medien-widget-inspectorcontrols-panelbody-categories",
					label: "Auswahl der Kategorien",
					value: attributes.category,
					options: medienCategories, //kommt von mbgi-post-loop.php (wp_localize_script)
					onChange: (newval) => setAttributes({ category: newval }),
					multiple: true,
				}),
				createElement(TextControl, {
					key: "mbgi-medien-widget-inspectorcontrols-panelbody-numberposts",
			...
			createElement(ServerSideRender, { 
				...
				key: "mbgi-medien-widget-serversiderender",
				block: 'modulbuero/medien-widget',
...
registerBlockType('modulbuero/medien-widget', {
    title: 'In den Medien',
    description: 'gibt eine Liste der Medien in der Sidebar aus',
    icon: sonnenblume,
    category: 'modulbuero',
    supports: {align: true},
	...
	example: {},
    edit: BlockEditPostLoopmedienWidget,    
