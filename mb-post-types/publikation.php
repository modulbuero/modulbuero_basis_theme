...
add_action( 'init', function(){
    $typName    = 'Publikationen';
    $typNames   = 'Publikationen';
    $typSlug    = 'publikation';
    $typMenuName= 'Publikationen';
    ...
    if(get_option($optionName) == "on"){
        register_post_type( $typSlug , array(
            ...
            //Customize
            'supports'                  => array( 'title','thumbnail', 'editor', 'revisions', 'excerpt',),//Titel, Beitragsbild, Beschreibung (Datei & Dateibezeichnung fehlt)
            'menu_position' 			=> 32,
